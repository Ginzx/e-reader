...
(function() {
  ...
  ImagePickerOption = (function() {
    ...
    ImagePickerOption.prototype.mark_as_selected = function() {
      return this.node.find(".thumbnail").addClass("selected").append("<img src='../images/check_y.png' style='top:10px;position:absolute;right:10px;' class='select_images'>").find(".nselect_images").remove();
    };

    ImagePickerOption.prototype.unmark_as_selected = function() {
      return this.node.find(".thumbnail").removeClass("selected").append("<img src='../images/check_n.png' style='top:10px;position:absolute;right:10px;' class='nselect_images'>").find(".select_images").remove();
    };
    ...
    ImagePickerOption.prototype.create_node = function() {
      ...
      if (this.opts.show_label) {
          thumbnail.append(jQuery("<p align='left' />").html(this.label()));
         }
