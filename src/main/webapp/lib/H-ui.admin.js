...
$(function(){
	...
	/*左侧菜单*/
	$.Huifold(".menu_dropdown dl dt[level='1']",".menu_dropdown dl dd[level='1']","fast",1,"click");
	//$.Huifold(".menu_dropdown dl dd ul li dt",".menu_dropdown dl dd ul li dd","fast",1,"click");
	/*选项卡导航*/
